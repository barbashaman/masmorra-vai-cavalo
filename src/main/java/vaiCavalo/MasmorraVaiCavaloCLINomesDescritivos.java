...
public class MasmorraVaiCavaloCLINomesDescritivos {

    public static void main(String[] args) {
        /*
        Objetos do sistema
        */
        Scanner leitorComandos = new Scanner(System.in);
        Random valoresRandomicos = new Random();

        /*
        Variáveis do jogo
        */
        String[] inimigos = {"Esqueleto", "Zumbi", "Guerreiro", "Assassino"};
        int vidaMaximaInimigos = 75;
        int danoAtaqueInimigos = 25;
        ...
        */
        int vidaJogador = 100;
        int danoAtaqueJogador = 50;
        int numeroPocoesVida = 3;
        int fatorCuraPocaoVida = 30;
        int chanceCairPocaoVida = 50;
